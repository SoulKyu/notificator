...
// TestOnCallFilterOverlap verifies that the on-call time-of-day filter counts an
// alert whose ACTIVE interval overlaps the 18:00-08:00 window, even when it fired
// during the day. Regression test for daytime-fired, long-running alerts being
// dropped from the statistics dashboard.
func TestOnCallFilterOverlap(t *testing.T) {
	...
	// Fixed anchor dates (UTC). Tue 2026-06-30, Mon 2026-06-29.
