...
helm.sh/chart: {{ include "notificator-backend.chart" . }}
{{ include "notificator-backend.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
app.kubernetes.io/name: {{ include "notificator-backend.name" . }}
...
{{- default (include "notificator-backend.fullname" .) .Values.serviceAccount.name }}
{{- else }}
